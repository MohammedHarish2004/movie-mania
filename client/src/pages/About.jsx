...
export default function About() {
  return (
    <div className='max-w-5xl min-h-screen mx-auto p-3'>
    ...
    <div className='text-start my-2'>
      ...
      <ul className='list-disc my-3 font-medium'>
      ...
      <p className='font-semibold text-xl text-center py-3'>Join us on Movie Mania and embark on a journey through the world of entertainment like never before. Let's make every viewing experience a memorable one!</p>
    </div>
