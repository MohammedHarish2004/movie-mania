      ...
      <div className='flex-none  p-3'>
        ...
        <form className='flex flex-col gap-3' onSubmit={handleSubmit}>
         ...
         <div>
            ...
            <input placeholder='email' id='email' className='bg-transparent block p-2 rounded-lg w-full outline-none border border-yellow-300' onChange={handleChange} autoComplete='off'/>
         </div>
         <div>
