...
export default function CreateSlider() {
    ...
    useEffect(()=>{
        const fetchSlider = async ()=>{
            const res = await fetch(`/api/slider/getSlider?sliderId=${sliderId}`)
            const data = await res.json()
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const res = await fetch(`/api/slider/editSlider/${sliderId}`,{
                method:"POST",
                headers:{
            ...
            toast.success('Slider Updated successfully',{autoClose:1500})
            navigate('/dashboard?tab=slider-list',{replace:true})
  ...
  return (
    <div className='flex flex-col md:flex-row min-h-screen'>
        ...
        <div className='max-w-5xl w-full p-7'>
            <h1 className='text-3xl'>Edit Slider</h1>
                ...
                <div className='flex flex-col md:flex-row gap-6 mt-8'>
                    ...
                    </div>
                   {
                    ...
                    <div className='flex-1'>
                        <img src={formData.image} className='w-auto h-40 mt-2 lg:mt-0'/>
                    </div>
                   }
                </div>  
                <div>
                    ...
                    >
                        ...
                        loading ? 
                        <span>
                            <Spinner size='sm' color='gray'/>Uploading...</span> : 'Update Slider'}
                        </span>
                    </button>
                </div>
            </form>
