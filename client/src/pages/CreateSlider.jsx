...
export default function CreateSlider() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const res = await fetch('/api/slider/createSlider',{
                method:"POST",
                headers:{
            ...
            toast.success('Slider Created successfully',{autoClose:1500})
  ...
  return (
        <div className='max-w-5xl w-full p-7'>
            <h1 className='text-3xl'>Create Slider</h1>
            <form onSubmit={handleSubmit} autoComplete='off'>
                ...
                <div>
                    ...
                    >
                        ...
                        loading ? 
                        <span>
                            <Spinner size='sm' color='gray'/>Uploading...</span> : 'Create Slider'}
                        </span>
                    </button>
                </div>
            </form>
