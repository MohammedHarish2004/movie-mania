    ...
    {/* Left */}
      <div className='flex-none p-3'>
        <div className='flex flex-col flex-wrap gap-5'>
          ...
          <div className='text-xl font-medium text-yellow-300 mb-6'>You can <span className='text-white'>Login</span> if your already have an account</div>
        </div>
        <form className='flex flex-col gap-3'>
         ...
         <button className=' bg-yellow-300 hover:bg-yellow-300 text-black p-2 rounded-lg font-bold transition delay-50 hover:opacity-85 mt-3' >Login</button>
        </form>
